...
<nav class="relative px-4 py-4 flex justify-between items-center bg-white border border-gray-400 ">
    ...
    <a class="hidden lg:inline-block py-2 px-6 bg-[#0077b5] hover:bg-blue-600 text-sm text-white font-bold rounded-xl transition duration-200" href="{{route('register')}}">Sign up</a>
    @endguest
    @auth
...
<div class="navbar-menu relative z-50 hidden">
    ...
    <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
        ...
        <div>
            <ul>
                <li class="mb-1">
                    <a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="{{route('feed.index')}}">Home</a>
                </li>
                <li class="mb-1">
