...
@section('content')
    <section class="p-6 dark:bg-gray-800 dark:text-gray-50">
        <form enctype="multipart/form-data" novalidate="" action="{{route('feed.store')}}" method="POST" class="container flex flex-col mx-auto space-y-12 ng-untouched ng-pristine ng-valid">
@csrf
            <fieldset class="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-900">
                <div class="space-y-2 col-span-full lg:col-span-1">
                    <p class="font-medium">Post information</p>
                    <p class="text-xs">This information will be displayed to everyone.</p>
                </div>
                <div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                    <div class="col-span-full sm:col-span-3">
                        ...
                        @enderror
                        <input value="{{old('title')}}" name="title" id="title" type="text" placeholder="Title" class="w-full border border-gray-600 p-2 rounded-md focus:ring focus:ring-opacity-75 focus:ring-violet-400 dark:border-gray-700 dark:text-gray-900">
                    ...
                    <div class="col-span-full">
                        ...
                        <textarea name="description" id="description" placeholder="Description" class="w-full  border border-gray-600 p-2  rounded-md focus:ring focus:ring-opacity-75 focus:ring-violet-400 dark:border-gray-700 dark:text-gray-900"></textarea>
                    </div>
                    <div class="col-span-full">
